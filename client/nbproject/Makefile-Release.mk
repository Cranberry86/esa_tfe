...
LDLIBSOPTIONS=-lsfml-system -lsfml-window -lsfml-graphics -lsfml-network -lconfig++
...
${OBJECTDIR}/Widget.o: Widget.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/local/include/SFML -MMD -MP -MF $@.d -o ${OBJECTDIR}/Widget.o Widget.cpp
...
${OBJECTDIR}/UDPNetwork.o: UDPNetwork.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/local/include/SFML -MMD -MP -MF $@.d -o ${OBJECTDIR}/UDPNetwork.o UDPNetwork.cpp

${OBJECTDIR}/TextInput.o: TextInput.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I/usr/local/include/SFML -MMD -MP -MF $@.d -o ${OBJECTDIR}/TextInput.o TextInput.cpp
